...
class ChatScraperAPI(BaseChatModel):
    ...
    """ScraperAPI chat model integration.
    ...
    Key init args — completion params:
        model: str
            Name of ScraperAPI model to use.
        temperature: float
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            ScraperAPI API key. If not passed in will be read from env var SCRAPERAPI_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatScraperAPI.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatScraperAPI.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatScraperAPI supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatScraperAPI supports async generation. Otherwise delete.
