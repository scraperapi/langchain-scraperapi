...
class ScraperAPIVectorStore(VectorStore):
    # TODO: Replace all TODOs in docstring.
    """ScraperAPI vector store integration.
    ...
    Instantiate:
        .. code-block:: python
            ...
            vector_store = ScraperAPIVectorStore(
                collection_name="foo",
    ...
    @classmethod
    def from_texts(
        cls: Type[ScraperAPIVectorStore],
        texts: List[str],
