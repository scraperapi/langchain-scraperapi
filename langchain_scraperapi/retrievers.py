...
class ScraperAPIRetriever(BaseRetriever):
    ...
    """ScraperAPI retriever.

    # TODO: Replace with relevant packages, env vars, etc.
    Setup:
        Install ``langchain-scraperapi`` and set environment variable
        ``SCRAPERAPI_API_KEY``.
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain-scraperapi import ScraperAPIRetriever

            retriever = ScraperAPIRetriever(
                # ...
            )
